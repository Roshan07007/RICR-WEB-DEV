...
const Login = () => {
  ...
  return (
    ...
    <div className="flex justify-center mt-4">
      <img src={img3} className="w-15 h-15 invert-100" alt="" />
    </div>
    <div className="flex ms-90   w-210 flex-col md:flex-row items-center justify-center   hide-scrollbar">
      
      <form
        className="w-[90%] md:w-[60%] px-4 py-8 md:p-17 flex justify-center items-center rounded-2xl flex flex-col gap-2 shadow-2xl"
